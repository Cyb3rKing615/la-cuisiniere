...
| `Boite-sauce-1.jpg`, `sauce_tomate.jpg` | Packshots Sauce Tomate |
| `Boite-puree-1.jpg`, `puree.png` | Packshots Purée de Tomate |
| `Boite-bolognaise.jpg`, `bolognaise.png`, `bolognaise--png.png` | Packshots Bolognaise |
| `Boite-pele.jpg`, `tomate_pelee.png` | Packshots Tomate Pelée |
| `Boite-barbecue.jpg` | Packshot Sauce Barbecue |
| `logo_abssa.jpg`, `logo_benibiz.jpg` | Logos de confiance/partenaires à afficher en pied de page ou section réassurance |
...
**⚠️ Point à confirmer avec le client avant de finaliser le catalogue** : les
images révèlent 5 produits (Sauce, Purée, Bolognaise, Tomate Pelée, Barbecue),
alors que les échanges précédents mentionnaient "3 produits phares". Vérifier
avec Madame Gouhizoun la liste exacte et définitive avant de figer les pages
produit.
